...
async function POST(request) {
    try {
        ...
        const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].team.findFirst({
            where: {
                id: parseInt(code)
            }
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/play/${team.id}`, request.url));
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8a1d7f._.js.map