...
"[project]/src/utils/booking-code.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function generateUniqueBookingCode() {
    ...
    while(attempts < maxAttempts){
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].booking.findUnique({
            where: {
                code
            }
        });
...
"[project]/src/app/api/bookings/[code]/reset/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/server/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$booking$2d$code$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/utils/booking-code.ts [app-route] (ecmascript)");
;
;
;
async function POST(request, context) {
    try {
        ...
        const upperCode = code.toUpperCase();
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$booking$2d$code$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValidBookingCode"])(upperCode)) {
        ...
        const booking = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].booking.findUnique({
            where: {
                code: upperCode
            },
            include: {
        ...
        const updatedInstance = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].gameInstance.update({
            where: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__793b18._.js.map